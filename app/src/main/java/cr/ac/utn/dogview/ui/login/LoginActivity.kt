package cr.ac.utn.dogview.ui.login
...
import cr.ac.utn.dogview.MainActivity
...
import cr.ac.utn.dogview.ui.breeds.BreedsActivity
import cr.ac.utn.dogview.ui.register.RegisterActivity
import cr.ac.utn.dogview.utils.Util
import cr.ac.utn.dogview.viewmodel.AuthViewModelFactory
import cr.ac.utn.dogview.viewmodel.LoginViewModel
        ...
        loginViewModel.loginResult.observe(this) { response ->
            ...
            if (response.isSuccessful) {
                ...
                if (userData != null && userData.isActive) {
                    ...
                    Util.openActivity(this, BreedsActivity::class.java)
                } else {
                    Toast.makeText(
                        this,
