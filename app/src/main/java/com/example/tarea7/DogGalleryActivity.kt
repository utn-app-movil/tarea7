        ...
        call.enqueue(object : Callback<DogImagesResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@DogGalleryActivity, getString(R.string.failed_fetch_images), Toast.LENGTH_SHORT).show()
                }
            }

            override fun onFailure(call: Call<DogImagesResponse>, t: Throwable) {
                Toast.makeText(this@DogGalleryActivity, getString(R.string.error_connection, t.message), Toast.LENGTH_SHORT).show()
            }
        })
    }
}
